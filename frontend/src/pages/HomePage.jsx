    ...
    <PageLayout>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 px-6 pt-32 pb-10">
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row gap-6">
          ...
          {/* LEFT - IMAGE (70%) */}
          <div className="w-full md:w-[70%] h-[50vh] md:h-[75vh] relative overflow-hidden shadow-lg">
            {bannersLoading ? (
              ...
              {noticesLoading ? (
                ...
                <div className="animate-scrollUpBottom group-hover:[animation-play-state:paused] space-y-5">
                  {[...notices, ...notices].map((notice, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-3 bg-slate-50/50 p-3 border border-slate-100 hover:border-primary/20 hover:bg-white transition-all"
                    >
